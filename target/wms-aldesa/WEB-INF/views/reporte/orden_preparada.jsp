                ...
                stack: [
                    {
                    	...
                    	columns: [
                            ...
                            {stack: [
                                {text: 'ORDEN PREPARACION Y ENTREGA No ${orden}', alignment: 'center',fontSize: 14},
        ...
        content: {
            ...
            stack:[
                ...
                {table:{
                    ...
                    widths: [ '*', 160, 40, 40, 40, 40, 40, '*', '*'],
                    body:[
                        ['Codigo','Descripcion', 'Estado Merc. Solicitada',
                            'Cantidad solicitada','Cantidad Preparada','Cantidad Entregada','Saldo de la Orden',
                            'Ubicacion','Bulk'],<c:forEach var="merc" items="${recepcion_mercaderia}" varStatus="loop"> <c:if test="${merc.getDeposito().equalsIgnoreCase(d)}" >
                        ['${merc.getCodigo()}', '${merc.getDescripcion()}', '${merc.getEstadoMercaderiaSolicitada()}',
                            '${merc.getCantidad()}', '${merc.getPreparadas()}', '${merc.getEntregadas()}','${merc.getSaldos()}',
                ...
                }}, </c:forEach>
                {
                    columns:[
                        ...
                        'TOTAL ENTREGADA ${tentregada}',  
                        'TOTAL SALDO DE LA ORDEN ${tsaldo}', ' '
                    ]
                }
            ]}
    };
