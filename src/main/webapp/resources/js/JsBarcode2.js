function CODE128(c, p) {
	...
	function d(a) {
		for (var g = "", e = 0; e < a.length; e += 2) g += b(parseInt(a.substr(e, 2)));
		return g
	}
	...
	function n(a, g) {
		for (var e = 0, k = 1, b = 0; b < a.length; b += 2) e += parseInt(a.substr(b, 2)) * k, k++;
		return (e + g) % 103
	}

	function b(a) {
		for (var b = 0; b < h.length; b++)
			if (h[b][2] == a) return h[b][1];
		return ""
	}
	p = p || "B";
	this.string128 = c + "";
...
function EAN(c) {
	function p(b, h) {
		for (var g = "", e = 0; e < b.length; e++) "L" == h[e] ? g += a[b[e]] : "G" == h[e] ? g += l[b[e]] : "R" == h[e] && (g += d[b[e]]);
		return g
	}
	...
	this.encoded = function() {
		if (-1 !== this.ITFNumber.search(l)) {
			...
			for (var n = 0; n < d.length; n += 2) {
				for (var b = d.substr(n, 2), h = "", c = p[b[0]], b = p[b[1]], k = 0; 5 > k; k++) h += "1" == c[k] ? "111" : "1", h += "1" == b[k] ? "000" : "0";
				f += h
			}
			return f += a
		}
	...
	this.encoded = function() {
		if (m(this.ITF14number)) {
			...
			for (var b = b + l, h = 0; 14 > h; h += 2) {
				for (var c = f.substr(h, 2), k = "", q = a[c[0]], c = a[c[1]], g = 0; 5 > g; g++) k += "1" == q[g] ? "111" : "1", k += "1" == c[g] ? "000" : "0";
				b += k
			}
			return b += d
		}
...
function pharmacode(c) {
	function p(c, a) {
		...
		for (f = 0;
			 "0" == c[l] || 0 > l;) f++, l--;
		0 == f ? (l = a ? "001" : "00111", d = a) : (l = "001".repeat(f - (a ? 1 : 0)), l += "00111");
		return p(c.substr(0, c.length - f - 1), d) + l
	}
	this.number = parseInt(c);
	this.encoded = function() {
		return this.valid(this.number) ? p(this.number.toString(2), !0).substr(2) : ""
	};
	this.valid = function() {
...
(function(c) {
	JsBarcodeBase64 = function(c, m, a, l) {
		a = function(a, b) {
			var c = {},
				d;
			for (d in a) c[d] = a[d];
		...
		var f = f.encoded(),
			n = function(c) {
				...
				b.textBaseline = "top";
				"left" == a.textAlign ?
					(f = a.quite, b.textAlign = "left") : "right" == a.textAlign ? (f = d.width - a.quite, b.textAlign = "right") : (f = d.width / 2, b.textAlign = "center");
				b.fillText(c, f, g)
			},
			b = d.getContext("2d");
		...
		a.backgroundColor && (b.fillStyle = a.backgroundColor, b.fillRect(0, 0, d.width, d.height));
	...
	window.jQuery && (c.fn.JsBarcodeBase64 = function(c, m, a) {
		JsBarcodeBase64(this, c, m, a);
		return this
	})
})(window.jQuery);